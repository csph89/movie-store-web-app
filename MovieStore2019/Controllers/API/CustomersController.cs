...
namespace MovieStore2019.Controllers.API
{
    public class CustomersController : ApiController 
    {
        ...
        public IEnumerable<CustomerDto> GetCustomers()
        {
            ...
            return _context.Customers.ToList().Select(Mapper.Map<Customer, CustomerDto>); //Here we pass a delegate to Select method.
        }
        ...
        public IHttpActionResult CreateCustomer(CustomerDto customerDto)
        {
            ...
            //The newly created customer object has an id that is generated by the dtabase.
